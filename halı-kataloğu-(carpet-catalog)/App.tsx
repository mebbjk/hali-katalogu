...
// FIX: Refactored hooks to be defined in their own files inside the 'hooks' directory.
// This resolves a stubborn module resolution error by breaking potential circular dependencies 
// between the context providers and the components that use them.
