...
export const StarIcon = ({ filled = false }: { filled?: boolean }) => (
    <svg {...iconProps} fill={filled ? "currentColor" : "none"} className={`w-6 h-6 ${filled ? 'text-yellow-400' : 'text-gray-400'}`}>
