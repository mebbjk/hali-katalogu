...
export const useCarpets = () => {
  const [carpets, setCarpets] = React.useState<Carpet[]>([]);
  ...
  const addCarpet = React.useCallback(async (carpetData: Partial<Carpet>, imageFile: File): Promise<Carpet> => {
    try {
  ...
  const updateCarpet = React.useCallback(async (updatedCarpet: Carpet) => {
    try {
  ...
  const deleteCarpet = React.useCallback(async (carpetId: string) => {
    try {
  ...
  const toggleFavorite = React.useCallback(async (carpetId: string) => {
  ...
  const replaceAllCarpets = React.useCallback(async (newCarpets: Carpet[]) => {
  ...
  const getDetailsFromImage = React.useCallback(async (imageFile: File) => {
    try {
  ...
  const findMatchByImage = React.useCallback(async (imageFile: File) => {
    try {
